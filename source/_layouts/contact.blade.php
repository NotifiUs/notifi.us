            ...
            <div class="mx-auto text-left align-middle">
                <div class="bg-white shadow px-4 py-10">
                    ...
                    <div class="flex flex-wrap justify-center">
                        <a title="Give us a call!" alt="+1 888-966-9830" class="rounded-lg block text-lg uppercase text-center text-purple-100 inline-block shadow bg-purple-700 my-4 px-5 py-3 hover:bg-purple-900 hover:text-white font-bold mx-auto w-10/12 lg:w-5/12" href="tel:+1 888-966-9830">
                            <i class="fas fa-phone text-purple-300"></i> Give us a call
                        </a>

                        <a title="Send us an email!" alt="support@notifi.us" class="rounded-lg block text-lg uppercase text-center text-purple-100 inline-block shadow bg-purple-700 my-4 px-5 py-3 hover:bg-purple-900 hover:text-white font-bold mx-auto w-10/12 lg:w-5/12" href="mailto:support@notifi.us">
        ...
        <div class="my-0 w-full sm:w-full md:w-2/5 lg:w-2/5 xl:w-2/5">
            <div class="mx-auto text-left align-middle">
                <div class="bg-gray-200 md:rounded md:rounded-tl-none md:rounded-bl-none  px-4 xl:px-6 py-8 text-center my-0 md:my-5 ">
                    ...
                    <div class="shadow border-gray-300 rounded-tl rounded-tr border-t border-l border-r my-0 py-2 bg-indigo-100">
                    ...
                    <div class="shadow border-gray-300 border-l border-r my-0 py-2 bg-indigo-200">
                    ...
                    <div class="shadow border-gray-300 rounded-bl rounded-br border-l border-r border-b my-0 py-2 bg-indigo-300">
...
<div class="container mx-auto px-4 max-w-3xl mt-4">
    <form class="bg-gray-300 rounded shadow px-4 py-8 mx-auto max-w-md md:max-w-full" method="POST" name="notifi.us/contact" data-netlify="true">
        <div class="flex flex-wrap">
            <h3 class="text-indigo-700 text-xl font-bold flex-row w-full max-w-2xl mx-auto mb-3">
            ...
            <div class="flex-row w-full md:w-1/2 px-3">
                ...
                <div class="flex items-start justify-between">
                    <button class="w-full max-w-md rounded-lg block uppercase text-center text-purple-100 shadow bg-purple-700 px-3 py-3 hover:bg-purple-900 hover:text-white font-bold" type="button">
