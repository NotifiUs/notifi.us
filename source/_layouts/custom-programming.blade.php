    ...
    <div class="flex flex-wrap max-w-6xl mx-auto">
        <div class="md:flex lg:w-5/12 md:w-8/12 px-4 py-8 bg-white shadow mx-auto -mt-10 mb-20">
            ...
            <div class="md:ml-2">
                ...
                <h5 class="font-extrabold text-center sm:text-center md:text-left lg:text-left xl:text-left  text-2xl text-purple-500">NAEO Preferred Vendor</h5>
        ...
        <div class="md:flex lg:w-5/12 md:w-8/12 px-4 py-8 bg-white shadow mx-auto -mt-10 mb-20">
            ...
            <div class="md:ml-2">
                ...
                <h5 class="font-extrabold text-center sm:text-center md:text-left lg:text-left xl:text-left text-2xl text-purple-500">Experienced With Amtelco</h5>
