        ...
        <div class="w-full lg:w-3/5 px-4 max-w-2xl mx-auto">
            <div class="container mx-auto text-center align-middle">
                ...
                <h1 class="text-white font-extrabold text-4xl  mb-0 mt-6">
                   We <i class="fas fa-heart text-yellow-200"></i> Telecom
                </h1>

                <div class="inline-block text-2xl text-blue-100">
                    Need help setting up telephony for <i class="font-semibold">SIP trunking</i> and <i class="font-semibold">remote operators</i> in your call center?
                    We can help you plan, develop, and implement a scalable telecom infrastructure to remote enable your workforce.
                </div>
        ...
        <div class="w-full lg:w-2/5 px-4">
            <div class="container mx-auto text-center lg:text-left max-w-xl">
                <div class="w-100 mx-auto">
                    <img class="w-full max-w-sm mx-auto" src="/assets/images/network.svg" title="Telecom network setup" alt="Call Theory Universe Premium Subscription">
                </div>
            </div>
        </div>
    </div>
