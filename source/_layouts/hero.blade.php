...
<div class="flex flex-wrap bg-gradient py-16 w-full px-4 shadow-inner mx-auto">
    <div class="lg:w-3/5 w-full px-4 max-w-3xl">
        <div class="container mx-auto text-center align-middle">
            ...
            <a alt="NotifiUs, LLC" class="rounded-lg block text-lg uppercase text-purple-100 inline-block shadow bg-purple-700 my-6 px-5 py-3 hover:bg-purple-900 hover:text-white font-bold" href="/contact">
                <i class="fas fa-check-circle text-purple-300"></i> We Can Help
            </a>
        </div>
    </div>
